...
screen_1.bgcolor("misty rose")  
screen_1.setup(width = 1050, height = 600)  
...
left_paddle.color("dark slate blue")  
...
right_paddle.color("saddle brown")  
...
sketch_1.speed(0)  
sketch_1.color("black")  
sketch_1.penup()  
sketch_1.hideturtle()  
sketch_1.goto(0, 260)  
sketch_1.write("Left Player : 0 Right Player: 0",  align = "center", font = ("Verdana", 24, "normal"))  
...
screen_1.listen()  
screen_1.onkeypress(paddle_L_up, "e")  
screen_1.onkeypress(paddle_L_down, "d")  
...
while True:  
    ...
    if hit_ball.xcor() > 500:  
        ...
        left_player += 1  
        sketch_1.clear()  
        sketch_1.write("Left Player : {} Right Player: {}".format(  left_player, right_player), align = "center",  font = ("Verdana", 24, "normal"))  
    ...
    if (hit_ball.xcor() > 360 and  
                        hit_ball.xcor() < 400) and (hit_ball.ycor() < right_paddle.ycor() + 40 and  
                        hit_ball.ycor() > right_paddle.ycor() - 40):  
                        hit_ball.setx(360)  
                        hit_ball.dx *= -1  
          
    if (hit_ball.xcor() < -360 and  
                       hit_ball.xcor() > -400) and (hit_ball.ycor() < left_paddle.ycor() + 40 and  
